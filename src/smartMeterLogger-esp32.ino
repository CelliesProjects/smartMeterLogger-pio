...
#include <SH1106Wire.h> /* Install via 'Manage Libraries' in Arduino IDE -> https://github.com/ThingPulse/esp8266-oled-ssd1306 */
#else
#include <SSD1306Wire.h> /* In same library as SH1106 */
#endif
...
#if defined(SH1106_OLED)
SH1106Wire oled(OLED_ADDRESS, I2C_SDA_PIN, I2C_SCL_PIN);
#else
SSD1306Wire oled(OLED_ADDRESS, I2C_SDA_PIN, I2C_SCL_PIN);
#endif
...
void loop()
{
    ...
    else
    {
        if (smartMeter.available())
        {
            ...
            static const auto TIMEOUT_MS = 200;
            int size = 0;
            ...
            log_i("telegram received - %i byte\ntelegram:\n%s", size, telegram);
